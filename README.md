...
Open `index.html` (or the live page) and drop an mp4 on the window.
...
- Give each capture a cue, title, description and notes
- Review and edit in the contact sheet, or open a capture in the lightbox
